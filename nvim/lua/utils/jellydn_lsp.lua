-- /utils/jellydn_lsp.lua
-- disabled if below line is active
-- if true then return {} end
-- https://github.com/jellydn/lazy-nvim-ide/blob/main/lua/utils/lsp.lua
...
M.stop_lsp_client_by_name = function(name)
  local clients = vim.lsp.get_clients() -- vim.lsp.get_active_clients() deprecated
...
M.emmylua_config_path = function()
  return get_config_path(".emmyrc.json")
end

M.emmylua_config_exist = function()
  local has_config = get_config_path(".emmyrc.json")
