...
-- good luck finding the other plugins that you have providing the same thing,
-- dumb cat.
return {
  {
    "j-hui/fidget.nvim",
    opts = {
      ...
      progress = {
        ...
        display = {
          ...
          done_ttl = 6,                   -- How long a message should persist after completion
      ...
      notification = {
        ...
        window = {
          ...
          avoid = { "neo-tree" },-- Filetypes the notification window should avoid
