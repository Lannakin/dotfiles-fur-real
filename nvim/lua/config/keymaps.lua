...
-- Clipboard Copy --
map("v", "<C-C>", "y:lua ClipboardYank()<cr>gv", { desc = "Copy to clipboard", silent = true })
map("n", "<C-C>", "yy:lua ClipboardYank()<cr>", { desc = "Copy to clipboard", silent = true })
map("i", "<C-C>", "<c-o>yy<c-o>:lua ClipboardYank()<cr>", { desc = "Copy to clipboard", silent = true })

-- Clipboard Cut --
map("v", "<C-X>", "x:lua ClipboardYank()<cr>", { desc = "Cut to clipboard", silent = true })
map("n", "<C-X>", "dd:lua ClipboardYank()<cr>", { desc = "Cut to clipboard", silent = true })
map("i", "<C-X>", "<c-o>dd<c-o>:lua ClipboardYank()<cr>", { desc = "Cut to clipboard", silent = true })

-- Clipboard Paste --
map("", "<C-V>", ":lua ClipboardPaste()<cr>p", { desc = "Paste from clipboard", silent = true })
...
-- Save --
map("n", "<C-S>", [[:retab | :w!<CR>]], { desc = "Save" })
map("i", "<C-S>", [[<c-o>:retab | :w!<CR>]], { desc = "Save" })
...
-- next
map("n", "<C-PageDown>", ":BufferLineCycleNext<CR>", { desc = "" })
map("i", "<C-PageDown>", "<c-o>:BufferLineCycleNext<CR>", { desc = "" })
-- prev
map("n", "<C-PageUp>", ":BufferLineCyclePrev<CR>", { desc = "" })
map("i", "<C-PageUp>", "<c-o>:BufferLineCyclePrev<CR>", { desc = "" })

-- Bufferline Move Tab --
-- next
map("n", "<C-ScrollWheelUp>", ":BufferLineMoveNext<CR>", { desc = "" })
map("i", "<C-ScrollWheelUp>", "<c-o>:BufferLineMoveNext<CR>", { desc = "" })
-- prev
map("n", "<C-ScrollWheelDown>", ":BufferLineMovePrev<CR>", { desc = "" })
map("i", "<C-ScrollWheelDown>", "<c-o>:BufferLineMovePrev<CR>", { desc = "" })

-- Move Lines --
-- normal mode
map("n", "<C-Down>", ":m .+1<CR>==", { desc = "" })
map("n", "<C-Up>", ":m .-2<CR>==", { desc = "" })
-- editor mode
map("i", "<C-Down>", "<Esc>:m .+1<CR>==gi", { desc = "" })
map("i", "<C-Up>", "<Esc>:m .-2<CR>==gi", { desc = "" })
-- visual mode
map("v", "<C-Down>", ":m '>+1<CR>gv=gv", { desc = "" })
map("v", "<C-Up>", ":m '<-2<CR>gv=gv", { desc = "" })

-- Commenter (alacritty - gnome-terminal)
-- map("n", "<C-_>", ":CommentToggle<CR>", { desc = "Toggle comment" })
-- map("i", "<C-_>", "<c-o>:CommentToggle<CR>", { desc = "Toggle comment" })
-- map("v", "<C-_>", ":'<,'>CommentToggle<CR>", { desc = "Toggle comment" })

-- Commenter (kitty - xterm)
map("n", "<C-7>", ":CommentToggle<CR>", { desc = "Toggle comment" })
map("i", "<C-7>", "<c-o>:CommentToggle<CR>", { desc = "Toggle comment" })
