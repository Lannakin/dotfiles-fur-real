...
map("n", "<C-B>", "<CMD>:Neotree toggle<CR>", { desc = "Toggle Neotree pane" })
map("i", "<C-B>", "<CMD>:Neotree toggle<CR>", { desc = "Toggle Neotree pane" })
...
-- Code Actions --
map( "n", "<Leader>c", ":lua require('telescope').extensions.code_actions.code_actions()<CR>",
