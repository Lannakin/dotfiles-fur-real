#!/bin/sh
# ./herbstluftwm/polybar/scripts/sustem-usb-udev.sh
# src https://github.com/polybar/polybar-scripts/blob/master/polybar-scripts/system-usb-udev/system-usb-udev.sh
